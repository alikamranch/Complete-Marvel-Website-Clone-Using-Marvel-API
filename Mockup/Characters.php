...
<head>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                type: "GET",
                url: "https://gateway.marvel.com:443/v1/public/characters?limit=32&apikey=63aecf3116ca56dd9b4d4a0723eb0eff",
                ...
                success: function(data) {
                    ...
                    for (var i = 0; i < characters.length; i++) {
                        list +=
                            ...
                            '<a href="" onClick="fetchComic(' + characters[i].id +
                            ')" data-toggle="modal" id=' + characters[i].id +
                            ' class="d-block mb-4 characterHeight">' +
                            '<img class="img-fluid img-thumbnail" style="width: 255; height: 300;"src=' +
                            characters[i].thumbnail.path + "." + characters[i].thumbnail.extension +
                            "></a></div>"
                    }
            ...
            $('#searchch').click(function() {
                ...
                url =
                    "https://gateway.marvel.com:443/v1/public/characters?nameStartsWith=search&limit=32&apikey=63aecf3116ca56dd9b4d4a0723eb0eff"
                    ...
                    success: function(data) {
                        ...
                        for (var i = 0; i < characters.length; i++) {
                            list +=
                                ...
                                ' class="d-block mb-4 characterHeight">' +
                                '<img class="img-fluid img-thumbnail" style="width: 255; height: 300;"src=' +
                                characters[i].thumbnail.path + "." + characters[i].thumbnail
                                .extension +
                                "></a></div>"
                        }
                        $("#characters").html(list);
        ...
        fetchComic(id) {
            for (var i = 0; i < characters.length; i++) {
                if (id == characters[i].id) {
                    $("#comicTitle").html(characters[i].name);
                    $("#comicCover").attr("src", characters[i].thumbnail.path + "." +
                        characters[i].thumbnail.extension);
                    $("#comicDescription").html(characters[i].description ? characters[i].description :
        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="Characters.php">Characters</a>
                    </li>
                    </li>
                    <li class="nav-item">
                ...
                <form class="form-inline mt-2 mt-md-0">
                    <a id="back" href="Characters.php" style="display: none"><span class="nav-link fas fa-arrow-left fa-lg"
                            style="color: #dee2e69e;"></span></a>
                    <div id="bar" class="input-group input-group-sm" style="display: none;">
                        <input id="charname" type="text" class="form-control" placeholder="Search" aria-label="Search">
                        <div class="input-group-append">
                            <span class="input-group-text mr-sm-2 "><a id="searchch" href="#" class="nav-link fas fa-search fa-lg"
        ...
        <div class="jumbotron AboutMastHead">
            <div class="container">
                <div class="masthead_container">
                    <h2 class="masthead_caption">CHARACTERS</h2>
                </div>
            </div>
        </div>
        <br>
            ...
            <div class="modal-content">
                ...
                <form id="Comicbook">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <img id="comicCover" class="img-center" src="" alt="thumbnail" width="400" height="500">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="modal-footer">
                        <a id="fav" name="" href="#" class="nav-link fas fa-heart fa-2x" style="color: #3c302e9e;"></a>
                    </div>
                </form>
            </div>
        </div>
